  ...
  return (
    <div className="responsive-width mobile-width px-40">
      ...
      <div className="flex">
        ...
        <div
          className=" px-40 pt-20 w-1/2 bg-cover "
      ...
      <div className="flex">
        ...
        <div
          className="mt-5 w-1/2 pt-10  pl-20 bg-cover"
          style={{ backgroundImage: "url(images/bg-object5.png)" }}
        >
          ...
          <p className="mt-5 text-[#A9AFC3] font-light text-sm  mx-auto leading-[33px]">
            Thus new ideas and ingenious solutions are born. Then we get to work
            with renewed vigor and inspiration. We are never bored.{" "}
          </p>
        </div>
      </div>
      ...
      <div className="flex pb-10">
        ...
        <div
          className=" px-40 pt-20 w-1/2 bg-cover"
          style={{
            backgroundImage: "url(images/bg-object5.png)",
            paddingRight: "12px",
          }}
        >
