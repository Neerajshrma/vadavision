      ...
      >
        ...
        <div className="flex flex-row gap-2 justify-between responsive-row">
          <div className="mt-5 flex flex-wrap ">
            <h1 data-aos='fade-up' className="text-5xl hero-heading fontchange text-change leading-[120%] font-bold text-white heading-width">
              We are creative & strong team
            </h1>
            <p data-aos='fade-up' className="text-[#A9AFC3] font-light text-sm  mx-auto leading-[33px]">
          ...
          <div className="pt-20 flex flex-wrap ball bg-cover flex justify-end">
            <div data-aos='fade-up'className="flex justify-center  items-center w-[200px] h-[200px] border border-2 rounded-full border-[#DD4242] justify-items-center">
              <div className="">
                {" "}
                <h1 
        ...
        <div className="flex items-center Our-experience gap-4 justify-between">
          <div className="pt-20 ">
            <div data-aos='fade-up'className="w-[200px] h-[200px] ball2 border border-2 rounded-full border-[#DD4242] flex justify-center items-center">
              <div>
                <h1 
                  className="font-bold text-center text-white text-5xl leading-[100%]"
                  style={{ fontFamily: "Mulish" }}
          ...
          <div className="mt-5 pt-10 bg-cover">
            <h1 data-aos='fade-up'className="hero-heading fontchange text-base leading-[120%] font-medium text-white">
              How the workday at Vadavision begins.{" "}
            </h1>
            <p data-aos='fade-up'className="mt-5 text-[#A9AFC3] font-light text-sm mx-auto leading-[33px]">
        ...
        <div className="flex pb-10 justify-between our-approach">
          <div className="mt-5 pt-12">
            <h1 data-aos='fade-up' className="text-base hero-heading pt-10 leading-[120%] font-medium text-white">
              Innovative Thinkers
            </h1>
            <p data-aos='fade-up'className="mt-8 text-[#A9AFC3] font-light text-sm  mx-auto leading-[33px]">
          ...
          <div className="pt-20 bg-cover">
            <div data-aos='fade-up' className="w-[200px] h-[200px] ball2 border border-2 item-center justify-center rounded-full border-[#DD4242] justify-items-center">
              <h1 
