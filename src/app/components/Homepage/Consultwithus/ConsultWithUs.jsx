    ...
    <div className="bg-black px-40 responsive-width py-20">
      <div className="flex flex-wrap items-center justify-between gap-10">
        ...
        <div className="w-4/12 full-width-responsive">
          <div
            data-aos="fade-up"
            className="flex border-l border-[#DD4242] consult-btn"
          >
            <div
              data-aos="fade-up"
              className="border-l-2 border-[#DD4242] h-14 consult-btn"
            ></div>
            <p
              data-aos="fade-up"
              className="Montserrat font-medium leading-[22px] pl-8 consult-btn text-basi text-white description"
            >
