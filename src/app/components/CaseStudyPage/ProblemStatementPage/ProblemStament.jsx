      ...
      >
        ...
        <div className="text-center flex justify-center  item-center font-semibold">
          <p className=" ">
            ...
            remains a challenge for many. Existing 360-degree camera apps often
            lack user-friendly interfaces, precise control, and efficient
            stitching algorithms, making the process cumbersome and
            time-consuming.
          </p>
        </div>
      </div>
