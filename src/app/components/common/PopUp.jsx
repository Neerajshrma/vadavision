...
const PopUp = ({ minWidth }) => {
  ...
  return (
    ...
    <div style={{display: (loading ? 'none' : 'block'), minWidth:'100%', height:'700px'}} className="calendly-inline-widget" data-url="https://calendly.com/pankil_joshi/discovery?hide_event_type_details=1&hide_gdpr_banner=1">
