    ...
    >
      <div className="my-5 mx-auto w-7/12 min-w-[300px] text-center">
        ...
        <div className="flex justify-between">
          <div className="mt-10">
            <span data-aos='fade-up' className="block text-[#DD4242] Montserrat text-3xl font-bold">
          ...
          <div className="mt-10">
            <span data-aos='fade-up' className="block text-white Montserrat text-3xl font-bold">
              {number.OurTeam}
            </span>
